...
{
    /// <summary>
    /// See: How to know the process locking a file http://tinyurl.com/jgp57p6
    /// Source: http://csharphelper.com/blog/2017/01/see-processes-file-locked-c/#google_vignette
    /// </summary>
    public static class FileLockWrapper
    {
        ...
        public static List<Process> GetProcesses(string path, bool suppressExceptions = true)
        {
